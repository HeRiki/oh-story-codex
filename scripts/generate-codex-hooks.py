...
HOOKS = [
    ("SessionStart", "startup|resume|clear|compact", "session-start", 10, "正在加载网文项目上下文"),
    ("PreToolUse", "Bash|apply_patch|Edit|Write", "pre-tool-prose-guard", 10, "正在检查正文写作前置条件"),
    ("PreToolUse", "Bash", "pre-tool-commit-advisory", 15, "正在检查网文提交提醒"),
    ("PreCompact", "manual|auto", "pre-compact", 10, "正在汇总网文项目上下文"),
    ("PostCompact", "manual|auto", "post-compact", 10, "正在恢复网文项目上下文"),
